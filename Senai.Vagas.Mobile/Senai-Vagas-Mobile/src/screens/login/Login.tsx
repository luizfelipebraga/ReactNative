...
export default function Login() {
  ...
  'o cadastro de novos usuarios é feito somente em nossa pagina WEB',
  [
    {
      text: 'Ir para WEB',
      onPress: () => Linking.openURL('http://senai-vagas.herokuapp.com/')
    },
    {
      text: 'Cancelar',
  ...
  { cancelable: false },) }} style={styles.buttonc}>
